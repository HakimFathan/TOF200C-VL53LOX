...
// const char* MQTT_username = "vo9bd0f4cqb8n6npdm54";
...
void PublishMQTT() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (client.connected()) {
      ...
      if (currentMillisUpload - previousMillisUpload >= 2000) {
        // jsonBuffer.clear();
        jsonBuffer["avr_distance"] = average;
        serializeJson(jsonBuffer, jsonString);
        client.publish("v1/devices/me/telemetry", jsonString);
